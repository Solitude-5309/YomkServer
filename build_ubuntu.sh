...
TEST_TARGETS=(TestYomkService TestYomkFunctionPool TestYomkContext TestYomkEventLoop TestYomkLogger TestYomkServerInfo TestYomkContextInfo TestYomkEventLoopInfo)
